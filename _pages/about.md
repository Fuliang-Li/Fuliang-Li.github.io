...
- FlowValve+: Multi-queue Packet Scheduling Framework on SoC-based SmartNICs. Shaoke Xi, **Fuliang Li#**, Xingwei Wang, KuiRen. <i>  IEEE Transactions on Service Computing (TC) </i>.  [CCF A]
